...
(function (PS) {
  ...
  const GODS = [
    ...
    { id: 'anubis', name: 'Anubis', title: 'The Weigher',    domain: 'Judgement & patience',   avatar: '𓁢', teach: 'Gemini & Orbits — strike both',
      teach_long: 'Two truths at once: Gemini — equal ranks back-to-back — is slappable, and so is an Orbit — the same rank circling one card between. Weigh the pile, then strike.',
    ...
    { id: 'horus',  name: 'Horus',  title: 'The Monk',       domain: 'Sky & precision',        avatar: '🦅', teach: 'Pure reaction — be faster',
      teach_long: 'No new rule. Only speed. Horus does not blink. Gemini and Orbits both count — slap before you think.',
    ...
    { id: 'set',    name: 'Set',    title: 'The Professor',  domain: 'Chaos & impulse',        avatar: '🌩', teach: 'Sequences — count the climb',
      teach_long: 'New lesson: three cards climbing or falling in rank are slappable. Set plays bait that only looks legal — a false slap costs you a card. Gemini and Orbits stay live.',
    ...
    { id: 'seshat', name: 'Seshat', title: 'The Scribe',     domain: 'Mathematics',            avatar: '📐', teach: 'Trines & the Void — the royal couple',
      teach_long: 'New law: a Queen and King aligned are a Trine — slap them. Parted by a single card, the Void — slap that too. Gemini, Orbits and sequences all stay live. Count everything.',
    ...
    { id: 'ra',     name: 'Ra',     title: 'The Shark',      domain: 'Supreme power',          avatar: '☀️', teach: 'All rules. No cues. No mercy.',
      teach_long: 'Every rule is live — Gemini, Orbits, Trines, the Void, sequences, top-and-bottom — and the slap cues are gone. See it yourself, or lose. The sun does not explain itself.',
      intro: '', defeat: '',
